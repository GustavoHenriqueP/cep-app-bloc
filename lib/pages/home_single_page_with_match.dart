import 'package:cep_app/pages/state_single_class_with_match/home_single_class_controller.dart';
import 'package:cep_app/pages/state_single_class_with_match/home_state.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class HomeSinglePageWithMatch extends StatefulWidget {
  const HomeSinglePageWithMatch({Key? key}) : super(key: key);

  @override
  State<HomeSinglePageWithMatch> createState() =>
      _HomeSinglePageWithMatchState();
}

class _HomeSinglePageWithMatchState extends State<HomeSinglePageWithMatch> {
